...
def exposure_evidence_summary(sessions: list[Session]) -> dict[str, Any]:
    ...
    return {
        ...
        "sufficient_for_empirical_frontier": sufficient,
        ...
        "evidence_source": "direct telemetry exposure records only",
        "assumption": (
            "Every call-bearing session has direct exposure evidence."
            if sufficient
            else "Missing direct exposure remains unknown; calls are not exposure evidence."
        ),
    }
